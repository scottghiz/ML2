...
# fit model on training data - XGBCLASSIFER #
model = XGBClassifier()
...
#pyplot.show()
plt.savefig('/home/scripts/PREDICT/ML_TRAINING/IMAGES/feature_importance.png')
...
plt.savefig('/home/scripts/PREDICT/ML_TRAINING/IMAGES/feature_importance_sort.png')
